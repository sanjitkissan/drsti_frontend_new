...
export default function OurPortfolio(){
    return(
        <section className="w-full main-container hidden lg:flex flex-col items-center justify-center gap-6 lg:my-24 my-12">
            <p className="tracking-wider text-2xl text-red-600">PAN India Operations.</p>
            <h1 className="text-2xl lg:text-4xl font-bold uppercase ">Our work impact on<span className=" text-red-600"> CORPORATE WORKPLACE</span></h1>
